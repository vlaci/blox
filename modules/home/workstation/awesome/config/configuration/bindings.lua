...
local client_cfg    = require("configuration.client")
local tags          = require("configuration.tags")
local clientmenu    = require("layout.clientmenu")
local mainmenu      = require("layout.mainmenu")
...
return {
    mouse = {
        global = gears.table.join(
            awful.button({ }, 3, function () mainmenu.menu:toggle() end),
    ...
    key = {
        global = (function()
            local k = gears.table.join(
                ...
                awful.key({ modkey,           }, "w", function () mainmenu.menu:show() end,
                ...
                awful.key({ "Mod1",           }, "Tab", clientmenu.toggle
                ...
                awful.key({ modkey, "Shift" },            "p",     function ()
                        client_cfg.enable_padding = not client_cfg.enable_padding
                    end,
