...
let
  sources = {
    ...
    "markdownlint-0.21.0" = {
      ...
      version = "0.21.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/markdownlint/-/markdownlint-0.21.0.tgz";
        sha512 = "rTxr0fbCFmS65oxXBD0HNy3/+PSukLS+b7Z6rGDWbjdRJp/e2dKj538r3KTn8oXrusx+ZtuYOozV2Knpnn0pkQ==";
      };
    };
